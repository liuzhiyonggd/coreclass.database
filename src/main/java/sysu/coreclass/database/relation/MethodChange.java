...
public class MethodChange {
	...
	/**
	 * �Ƚ��¾ɷ����������ġ�ɾ���ġ��޸ĵĴ���� ��������ڸ����б���
	 * ����oldStates��newStates�����˸����������ƥ��ġ������ġ�ɾ���Ļ����޸ĵ�״̬
	 */
...
//		}
		...
		for (int i = 0; i < newStates.length; i++) {
			...
			if (newStates[i] == 2) {
				StatementBean statementBean = new StatementBean();
				statementBean.setStatement(newStatements.get(i));
				statementBean.setStatementeType("new");
				statementBean.setStatementID(i);
				statementList.add(statementBean);
		...
		for (int i = 0; i < oldStates.length; i++) {
			if (oldStates[i] == 3) {
				StatementBean statementBean = new StatementBean();
				statementBean.setStatement(oldStatements.get(i));
				statementBean.setStatementeType("delete");
				statementBean.setStatementID(i);
				statementList.add(statementBean);
...
//		System.out.println(newMethod.getName().getFullyQualifiedName());
//
...
//		for (int i = 0; i < oldStates.length; i++) {
//			System.out.print(oldStates[i] + " ");
//		}
//		System.out.println();

		// if(addedStatements!=null){
		// for(int i=0;i<addedStatements.size();i++){
		// System.out.println("add "+i+":"+addedStatements.get(i));
		// }
		// }
		// if(changedStatements!=null){
		// for(int i=0;i<changedStatements.size();i++){
		// System.out.println("change "+i+":"+changedStatements.get(i));
		// }
		// }
	}
